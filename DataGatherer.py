...
class DataGatherer:
    ...
    def autoscale(self):
        ...
        self._queue_average = self._queue_average * (
            self._autoscale_count / (self._autoscale_count + 1)
        ) + queue_size * (1 / (self._autoscale_count + 1))
    ...
    def run(self):
        ...
        while True:
            ...
            if uptime % 5 == 0:
                self.logger.warning(
                    f"# Proc: {len(self.recording_processes)} | Unsaved Q Size: {self.unsaved_data.qsize()} | "
